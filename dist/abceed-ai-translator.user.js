...
(() => {
  ...
  style.textContent = `
    ...
    *{box-sizing:border-box}button,input{font:inherit}button{cursor:pointer;transition:background .16s,box-shadow .16s,transform .16s}button:focus-visible,summary:focus-visible{outline:3px solid #fda4af;outline-offset:3px}button:active{transform:translateY(1px)}
    ...
    .panel{width:min(340px,calc(100vw - 32px));max-height:calc(100dvh - 94px);overflow:auto;overscroll-behavior:contain;scrollbar-width:thin;scrollbar-color:#dadde3 transparent;background:#fff;border:1px solid #e7e8ed;border-radius:22px;margin-bottom:12px;box-shadow:0 12px 48px #1720331c,0 2px 8px #17203306;text-align:left}
